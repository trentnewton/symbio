      <nav class="tab-links" data-sr="enter bottom wait 0.5s">
        <a href="#first-section"><?php print render($content['field_about_first_section_title']); ?></a>
        <a href="#second-section"><?php print render($content['field_about_second_section_title']); ?></a>
        <a href="#third-section"><?php print render($content['field_about_third_section_title']); ?></a>
      </nav>
    </div>
  </div>
</section>
