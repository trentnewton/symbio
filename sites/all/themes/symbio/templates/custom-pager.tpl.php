 ...
 */
?>
<ul class="pagination text-center custom-pager custom-pager-<?php print $position; ?>" role="navigation" aria-label="Pagination">
	<li class="pagination-previous"><?php print $previous; ?></li>
	<li class="key"><?php print $key; ?></li>
	<li class="pagination-next"><?php print $next; ?></li>
</ul>